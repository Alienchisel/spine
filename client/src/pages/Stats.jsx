...
export default function Stats() {
  ...
  const hero = [
    ...
    { label: 'Pages read',       value: pagesRead?.toLocaleString() ?? '—', to: '/?tab=owned&formats=physical' },
    { label: 'Hours listened',   value: minutesListened > 0 ? Math.floor(minutesListened / 60).toLocaleString() : '—', to: '/?tab=owned&formats=audiobook' },
