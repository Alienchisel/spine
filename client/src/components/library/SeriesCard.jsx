...
export default function SeriesCard({ seriesName, books, expanded, onToggle, compact }) {
  ...
  return (
    ...
    >
      ...
      <div className={`relative aspect-[2/3] overflow-hidden ring-2 ring-white/5 group-hover:ring-4 group-hover:ring-oak/70 transition-[box-shadow] duration-150 ${compact ? 'rounded-sm' : 'mb-2.5 rounded shadow-[0_10px_20px_-5px_rgba(0,0,0,0.55),0_4px_8px_-2px_rgba(0,0,0,0.35)]'}`}>
