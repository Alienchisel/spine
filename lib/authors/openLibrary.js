...
// Abortable JSON fetch. 8s default is fine for one-key author-detail
// lookups; the multi-token search endpoint (searchAuthor / searchAuthorsMulti)
// passes ms=15000 — OL's /search index routinely spikes past 5s under load,
// same shape as the book search timeout bump.
