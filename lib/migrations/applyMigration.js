...
//
// The runner gates on whether the migration SQL disables foreign_keys.
...
//
// SQLite accepts OFF / 0 / false (case-insensitive) as the "disable"
// value for PRAGMA foreign_keys; the gate matches all three so a
// migration written with the numeric or boolean form isn't silently
// downgraded to the txn-wrapped path.
export const FK_DISABLE_RE = /PRAGMA\s+foreign_keys\s*=\s*(OFF|0|false)\b/i;
