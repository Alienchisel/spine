...
export function buildFilterConditions(query) {
  ...
  // Original-language multi-select. Targets `original_language` (the
  // language the work was written in), not `language` — that one is ~99%
  // English and useless to filter on, while original_language is the
  // axis that meaningfully partitions the translated corpus (Greek
  // Loebs, German philosophy, French literature, etc.).
