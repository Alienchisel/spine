...
export function buildFilterConditions(query) {
  ...
  for (const m of missing) {
    ...
    else if (m === 'source')     conditions.push("owned = 1 AND (acquisition_source IS NULL OR acquisition_source = '')");
    else if (m === 'acquired')   conditions.push("owned = 1 AND acquisition_date IS NULL");
  }
