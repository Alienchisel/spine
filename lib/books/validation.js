...
export function validateBook(body) {
  ...
  if (date_started && !isValidDate(date_started.trim())) push('Invalid date started', 'date_started');
  if (date_finished && !isValidDate(date_finished.trim())) push('Invalid date finished', 'date_finished');
