...
function bookColumns(payload, extra = {}) {
  ...
  // can only be 1 when the book isn't currently owned (the form mirrors
  // this exclusivity at AcquisitionFields.jsx:14).
  ...
  // previously owned. AcquisitionFields.jsx:56 already hides the inputs
  // when neither flag is set — so without server-side normalisation, a
