...
export function patchBook(id, patch) {
  ...
  const { current_page, current_minutes, loved, on_readlist, is_stub, fiction, owned, previously_owned, acquisition_source, description, archived, binding, format, condition, rating, publisher, isbn_10, isbn_13, acquisition_date, date_started, date_finished, year_published, year_edition, page_count, duration_minutes, series_number, authors, narrators, translators, tags, shelf_id, unit_id, room_id, building_id } = patch;
