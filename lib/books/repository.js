...
export function getBook(id) {
  ...
  return { ...book, cover_path: toCoverUrl(book.cover_path), tags: [...tags, ...computeVirtualTags(book)], narrators, authors, translators, editions };
}
...
export function getBookCounts() {
  ...
  const row = db.prepare(`
    SELECT
      ...
      SUM(status = 'paused'    AND COALESCE(archived,0) = 0) AS paused,
