...
import { LIST_BOOK_SELECT } from './joinedFields.js';
...
export function getBookFacets(query) {
  ...
  // `original_language` for the BookForm datalist. The FilterPanel needs
  // just original_language values so the chips partition the translated
  // corpus instead of being smeared with the trivially-English reading
  // language.
