...
export function patchBook(id, patch) {
  ...
  const { current_page, current_minutes, loved, on_readlist, is_stub, fiction, acquisition_source, description, archived, binding, format, condition, rating, publisher } = patch;
