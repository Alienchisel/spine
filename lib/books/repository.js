...
export function patchBook(id, patch) {
  ...
  const { current_page, current_minutes, loved, on_readlist, is_stub, fiction, acquisition_source, description, archived, binding, format, condition, rating, publisher, isbn_10, isbn_13, acquisition_date, date_started, date_finished } = patch;
