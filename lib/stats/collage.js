...
export const ALLOWED_MODES   = Object.freeze(['top_books', 'top_authors', 'recently_finished']);
...
export function computeCollage({ mode, period, size }) {
